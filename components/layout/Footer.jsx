    ...
    <footer className="bg-white/90 backdrop-blur-md border-t border-gray-200 text-gray-700 pt-12 pb-6 mt-auto">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-3">
              {['About', 'Testimonials', 'Login'].map((item) => {
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-4 mb-6">
              {[
                { icon: FaFacebook, color: "hover:bg-blue-600", shadow: "hover:shadow-blue-500/50" },
                { icon: FaInstagram, color: "hover:bg-pink-600", shadow: "hover:shadow-pink-500/50" },
                { icon: FaYoutube, color: "hover:bg-red-600", shadow: "hover:shadow-red-500/50" },
                { icon: FaWhatsapp, color: "hover:bg-green-500", shadow: "hover:shadow-green-500/50" }
              ].map((social, idx) => (
                <a
                  key={idx}
                  href="#"
                  className="p-2 rounded-full bg-gray-100 text-gray-600 hover:text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            ...
            <div className="space-y-3 text-sm">
              ...
              <p className="flex items-center justify-center sm:justify-start gap-3 group cursor-pointer">
                ...
                <span className="group-hover:text-primary transition-colors">Bhubaneswar, Odisha</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} A&M Matrimony. All rights reserved.</p>
